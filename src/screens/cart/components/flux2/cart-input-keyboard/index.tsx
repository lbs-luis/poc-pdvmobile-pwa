...
export function CartInputKeyboard() {
  return (
    <div className="flex w-full flex-col gap-4 rounded-md bg-slate-200 p-2 pb-4 shadow-md/50 shadow">
      <div
        className="mx-auto h-1.5 w-26 rounded-full bg-slate-400"
        id="keyboard-drag-bar"
      />
